...
public class ElasticSearchHandler {
	...
	public ElasticSearchHandler(String ipAddress) {
		 ...
		 */
		InetSocketAddress isa = new InetSocketAddress(ipAddress, 9300);
		client = TransportClient.builder().build().addTransportAddress(new InetSocketTransportAddress(isa));
	}
	...
	public static void main(String[] args) {
		...
		QueryBuilder queryBuilder = QueryBuilders.queryStringQuery("感冒").field("name");
