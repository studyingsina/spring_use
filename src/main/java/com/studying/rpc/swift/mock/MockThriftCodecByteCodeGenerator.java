...
import com.facebook.swift.codec.internal.compiler.byteCode.*;
 ...
 */
public class MockThriftCodecByteCodeGenerator<T> {
    ...
    private final MockThriftCodecByteCodeGenerator.ConstructorParameters parameters = new MockThriftCodecByteCodeGenerator.ConstructorParameters();
    ...
    public MockThriftCodecByteCodeGenerator(
