...
public class ResultInt implements org.apache.thrift.TBase<ResultInt, ResultInt._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(ResultInt other) {
    ...
    ResultInt typedOther = (ResultInt)other;
